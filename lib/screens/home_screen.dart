...
import 'package:portfolio_monika/constants.dart';
import 'package:portfolio_monika/extensions.dart';
import 'package:portfolio_monika/main.dart';
import 'package:portfolio_monika/widgets/AppBarWidgets.dart';
import 'package:portfolio_monika/widgets/animatedBacground.dart';
import 'package:portfolio_monika/widgets/project_card.dart';
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
            ...
            title: const Text('M O N I K A . N . B',
              ...
              children: [
                Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text(
                          '   Hi, I\'m Monika, a passionate Flutter developer with a keen eye for detail and a strong commitment to creating high-quality mobile applications. With a background in computer science and over 3 years of professional experience, I specialize in building cross-platform apps that are both functional and visually appealing.',
                      ...
                      LayoutBuilder(builder: (context, c) {
                        ...
                        return SizedBox(
                          ...
                          child: PageView.builder(
                              ...
                              itemBuilder: (ctx, ind) {
                                Map<String, dynamic> e = Constants.technical_skills[ind];
                                return Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(20),
