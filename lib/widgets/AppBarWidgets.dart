...
import 'package:portfolio_monika/screens/home_screen.dart';
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
        ...
        decoration: BoxDecoration(
            color: notSelected ? Colors.transparent : Colors.white.withOpacity(0.1),
            border: notSelected
                ? null
                : Border.all(
                    color: Colors.black,
            ...
            gradient: notSelected
                ? null
                : LinearGradient(
                    colors: [Colors.black.withOpacity(0.1), Colors.green.withOpacity(0.3)]),
