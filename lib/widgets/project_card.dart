...
import 'package:portfolio_monika/blocs/project_part/project_bloc.dart';
import 'package:portfolio_monika/blocs/project_part/project_state.dart';
import 'package:portfolio_monika/extensions.dart';
import 'package:portfolio_monika/main.dart';
import 'package:portfolio_monika/viewmodels/project_viewmodel.dart';
import 'package:portfolio_monika/widgets/common_widgets.dart';
                            ...
                            builder: (context, ds) {
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: ds.connectionState == ConnectionState.waiting
                                        ? null
                                        : DecorationImage(
                                            fit: BoxFit.cover,
              ...
              onTap: () async {
                if (project.appUrl != null) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                      "Currently ${project.title} is Unavailable in Playstore !".toSnack());
                }
              },
              child: Card(
                  color: Colors.white.withOpacity(0.1),
